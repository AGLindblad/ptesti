...
def initDb():
  ...
  game = Game(title="Lost Planet 2", platform="Xbox 360", onsale="yes", bywhom="Jay", comment="Seems like a good 4-player title, should we grab it?")
  db.session.add(game)

  game = Game(title="Among US", platform="PC", onsale="no", bywhom="Ben", comment="It's a new release, would you guys be willing to play it with me?")
  db.session.add(game)
